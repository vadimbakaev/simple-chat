...
import vbakaev.app.chat.{ChatConnectionHandler, ChatConnectionHandlerImpl}
...
object Main extends App with LazyLogging {
  ...
  val chatConnectionHandler: ChatConnectionHandler = new ChatConnectionHandlerImpl()
      ...
      config => {
        RunnableGraph
          .fromGraph(GraphDSL.create() { implicit builder =>
            ...
            val tcpConnectionHandler = Sink.foreach[Tcp.IncomingConnection](chatConnectionHandler.handleConnection)
